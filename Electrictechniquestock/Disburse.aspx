<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Disburse.aspx.cs" Inherits="Electrictechniquestock.Disburse" %>
...
<%--        <div class="form-inline" style="padding: 10px">
        ...
        <div class="form-inline" style="padding: 10px">
            ...
            <div class="form-group">
             ...
             <asp:label ID="tbst_id" runat="server"></asp:label>
           </div>
            </div>
         <div class="form-inline" style="padding: 10px">
            <div class="form-group">
          ...
          <div class="form-group">
                        <label>คงเหลือ :</label>
                        <asp:TextBox ID="TxItemtotal_amount" runat="server" CssClass="form-control"></asp:TextBox>
           </div>
           <div class="form-group">
          ...
          <div class="form-inline" style="padding: 10px">
                <div class="form-group">
                        <label>จ่ายจำนวน :</label>
               <asp:TextBox ID="Txamount_disburse" runat="server" CssClass="form-control"></asp:TextBox>
           </div>
