<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Stock.aspx.cs" Inherits="Electrictechniquestock.Stock" %>
...
<asp:Content ID="Body" ContentPlaceHolderID="BodyContent" runat="server">
  <div class="messagealert" id="alert_container"></div>
    <section class="content-header">
        <h1>รายการคลังอุปกรณ์ไฟฟ้า R&D Engineering</h1>
    </section>
